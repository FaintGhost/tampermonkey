...
| [uber-invoice-downloader](uber-invoice-downloader/) | Uber 行程票据下载：批量下载（生成明细 CSV）+ 每张行程卡片单独下载按钮（Invoice 优先，Receipt 兜底） | [GreasyFork](https://greasyfork.org/zh-CN/scripts/594485) |
